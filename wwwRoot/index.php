...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	<head>
		...
		<title>A Travel Concierge</title>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-970PC7JB1V"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-970PC7JB1V');
</script>
	</head>
	<body>
	<div class="jumbotron">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
				<img src="img/polaroids.jpg" class="img-responsive">
			</div>
		</div>
		<hr>
